...
<div class="pwell hidden-print d-print-none">   
    <div class="row">
        <div class="col-sm-12">
...
<div class="row hidden" id="divToClone">
    ...
    <div class="col-sm-1">
        <button class="close retrit mt-4"><i class="fa fa-times"></i> </button>
    </div>
...
<div class="modal fade hidden-print" id='reportModal' data-backdrop='static' role='dialog'>
...
<style>
    .hidden {display:none}
    span.form-control {padding:none; padding-left:5px}
    select.form-control {height:default}
</style>
