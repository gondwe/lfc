    ...
    <div class="table-responsive">
        <table id='example' class="table-bordered table-striped" width='100%'>
            ...
            <tbody>
                ...
                <tr>
                    <th><?= $sn ?>.</th>
                    <td><a class="pointer vtr text-link" title="Click to view receipt"><?= $get->ref ?></a></td>
                    <td><?= $get->quantity ?></td>
                    <td>KES <?= number_format($get->totalMoneySpent, 2) ?></td>
                    <td>KES <?= number_format($get->amountTendered, 2) ?></td>
                    <td>KES <?= number_format($get->changeDue, 2) ?></td>
